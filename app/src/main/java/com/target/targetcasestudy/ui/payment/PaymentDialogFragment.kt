...
class PaymentDialogFragment : DialogFragment() {
  ...
  override fun onCreateView(
    ...
    submitButton.setOnClickListener {
      ...
      if(validateCreditCard(creditCardInput.text.toString())){
        Toast.makeText(context,"Valid Credit Card",Toast.LENGTH_LONG).show()
        dismiss()
      }else{
        Toast.makeText(context,"InValid Credit Card",Toast.LENGTH_LONG).show()
        dismiss()
      }
    }
